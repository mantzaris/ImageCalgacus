...
from .layers import (gated_resnet, down_shifted_conv2d, down_right_shifted_conv2d,
                     down_shifted_deconv2d, down_right_shifted_deconv2d, nin) 
from .ops import concat_elu 
...
class PixelCNN(nn.Module):
    ...
    def forward(self, x, sample=False):
        # Fresh padding follows the input device/dtype; no stale state across sequences.
        ...
        if u_list or ul_list:
            raise RuntimeError("unconsumed skip connections")
